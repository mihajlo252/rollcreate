            ...
            >
                ...
                >
                    <div className={`${CardStyles.card}`}>
                        <h1
                            className={`text-3xl text-neutral self-center ${CardStyles.char_name}`}
                        >
                            {meta_data.name}
                        </h1>
                        <p className="text-neutral-400">
                            {meta_data.race.sub}, {meta_data.class.main}
                        </p>
                    </div>
                </div>
            </NavLink>
            ...
            >
                <div className={`${CardStyles.card}`}>
                    ...
                    <div className={`${CardStyles.main_traits}`}>
                        <div className="grid min-h-6 grid-cols-3 place-items-center gap-2 px-1 text-sm">
